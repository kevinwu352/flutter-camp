...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/alert_done.svg
  SvgGenImage get alertDone =>
      const SvgGenImage('assets/images/alert_done.svg');

  /// File path: assets/images/alert_warn.svg
  SvgGenImage get alertWarn =>
      const SvgGenImage('assets/images/alert_warn.svg');
  ...
  /// File path: assets/images/jessica.jpg
  AssetGenImage get jessica => const AssetGenImage('assets/images/jessica.jpg');

  /// File path: assets/images/num.png
  AssetGenImage get num => const AssetGenImage('assets/images/num.png');
