...
class EventBus {
  ...
  StreamSubscription<Event> listen({required EventType type, required void Function(Event event) onEvent}) {
    return _controller.stream.where((event) => event.type == type).listen(onEvent);
  }
